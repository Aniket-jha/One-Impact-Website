...
export declare const initialize: (props: Partial<MuxMediaPropsInternal>, mediaEl?: HTMLMediaElement | null | undefined, core?: PlaybackCore | undefined) => {
...
export declare const setupHls: (props: Partial<Pick<MuxMediaPropsInternal, 'debug' | 'streamType' | 'type' | 'startTime' | 'metadata' | 'experimentalCmcd'>>, mediaEl?: Pick<HTMLMediaElement, "canPlayType"> | null | undefined) => Hls | undefined;
...
export declare const setupMux: (props: Partial<Pick<MuxMediaPropsInternal, 'envKey' | 'playerInitTime' | 'beaconCollectionDomain' | 'errorTranslator' | 'metadata' | 'debug' | 'playerSoftwareName' | 'playerSoftwareVersion' | 'playbackId' | 'src' | 'customDomain' | 'disableCookies'>>, mediaEl?: HTMLMediaElement | null | undefined, hlsjs?: Hls | undefined) => void;
export declare const loadMedia: (props: Partial<Pick<MuxMediaProps, 'preferPlayback' | 'src' | 'type' | 'startTime' | 'streamType' | 'autoplay'>>, mediaEl?: HTMLMediaElement | null | undefined, hls?: Pick<Hls, "config" | "once" | "liveSyncPosition" | "loadSource" | "on" | "subtitleTracks" | "subtitleTrack" | "destroy" | "attachMedia" | "startLoad" | "stopLoad" | "recoverMediaError"> | undefined) => void;
