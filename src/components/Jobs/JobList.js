...
const JobList = ({ jobs }) => {
  ...
  return (
    ...
    {jobs.length !==0 ?  <div className="container">
                      ...
                      <div className="cont">
                        <div>
                          ...
                          <div className="btn-more mt-30">
                              ...
                              <a href="#contact-arch" className="simple-btn">Apply Now</a>
      ...
      </div> : <h1 style={{textAlign:"center",marginTop:"80px"}}>No Jobs Right Now</h1>}
    </section>
  );
};
